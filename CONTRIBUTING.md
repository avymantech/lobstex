Contributing to Lobstex Core
============================

The Lobstex Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Lobstex Core project, and is not to be
confused with overall Lobstex Network Protocol consensus changes.

Whether a pull request is merged into Lobstex Core rests with the project merge
...
Patches that change Lobstex consensus rules are considerably more involved than
...
Where a patch set proposes to change the Lobstex consensus, it must have been
...
The project leader is the release manager for each Lobstex Core release.
