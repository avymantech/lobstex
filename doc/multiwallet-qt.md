...
In order to support loading of multiple wallets in lobstex-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is lobstex.cpp.
...
Changes to lobstex.cpp
----------------------
lobstex.cpp is the entry point into lobstex-qt, and as such, will require some minor modifications to provide hooks for
