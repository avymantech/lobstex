...
This mechanism has been integrated into Bitcore-Node-Lobstex which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Lobstex-Project/insight-api-lobstex#web-socket-api](https://github.com/Lobstex-Project/insight-api-lobstex#web-socket-api) 
* API: [https://github.com/Lobstex-Project/insight-api-lobstex#swifttx-transactions](https://github.com/Lobstex-Project/insight-api-lobstex#swifttx-transactions) 
...
By default, the Lobstex Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Lobstex Core daemon:
