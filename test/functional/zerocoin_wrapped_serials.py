#!/usr/bin/env python3
# Copyright (c) 2019 The Lobstex Core developers
...
from fake_stake.base_test import Lobstex_FakeStakeTest

class zLOBSwrappedSerialsTest(Lobstex_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zLOBSs..." % DENOM_TO_USE)
