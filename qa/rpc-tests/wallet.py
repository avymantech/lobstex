...
#   c) node1 mines 32 blocks, so now node 0 has 60001lobs, node 1 has 4250lobs, node2 has none.
#   d) node0 sends 601 lobs to node2, in two transactions (301 lobs, then 300 lobs).
