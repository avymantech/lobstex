...
#ifndef Lobstex_ZLOBSWALLET_H
#define Lobstex_ZLOBSWALLET_H
...
public:
    CzLOBSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLOBS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLOBS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
