...
#ifndef Lobstex_ZLOBSTRACKER_H
#define Lobstex_ZLOBSTRACKER_H
...
public:
    CzLOBSTracker(std::string strWalletFile);
    ~CzLOBSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzLOBSWallet* zLOBSWallet = NULL);
