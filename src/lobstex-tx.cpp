...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Lobstex Core lobstex-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  lobstex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lobstex transaction") + "\n" +
                               "  lobstex-tx [options] -create [commands]   " + _("Create hex-encoded lobstex transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lobstex transaction
