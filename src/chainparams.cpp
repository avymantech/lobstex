...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000ae505c7dde58f3087c6e641acc3d9d3490c881ec82db34b74511c04fe1e"))
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("03a63420598f28d37d97e3faa5c2d3a60f81622f915539ae7e6bdcd11bf867900f");
        nDefaultPort = 14146;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Lobstex starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Lobstex: 1 day
        nTargetSpacing = 1 * 60;  // Lobstex: 1 minute
        nMaturity = 60;
        ...
        nBlockDoubleAccumulated = 9999999;
        nEnforceNewSporkKey = 1525158000; //!> Sporks signed after (GMT): Tuesday, May 1, 2018 7:00:00 AM GMT must use the new spork key
        nRejectOldSporkKey = 1527811200; //!> Fully reject old spork key after (GMT): Friday, June 1, 2018 12:00:00 AM

        // Fake Serial Attack
        nFakeSerialBlockheightEnd = 99999999;
        nSupplyBeforeFakeSerial = 99999999999 * COIN;   // zerocoin supply at block nFakeSerialBlockheightEnd
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Lobstex Launch";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1525015537;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 11819562;
		...
		vSeeds.push_back(CDNSSeedData("144.202.106.254", "144.202.106.254"));
		
		devAddress = "LcjNDLwvJQBFkLgM8hrcsFYGFbrh4nQ7BU";
        devAddress2 = "LXYsa3jGL1K2qqmhsbgZGeHDXHLe6Cxbg4";
        ...
        strSporkKey = "03a63420598f28d37d97e3faa5c2d3a60f81622f915539ae7e6bdcd11bf867900f"; 
        strSporkKeyOld = "03a63420598f28d37d97e3faa5c2d3a60f81622f915539ae7e6bdcd11bf867900f";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zlobs to be stakable
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "lobstex-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "lobstex-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet lobstex addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet lobstex script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet lobstex BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet lobstex BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet lobstex BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Lobstex: 1 day
        nTargetSpacing = 1 * 60;        // Lobstex: 1 minutes
