...
/**
 * Lobstex RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzlobsseed(const UniValue& params, bool fHelp);
extern UniValue getzlobsseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzlobs(const UniValue& params, bool fHelp);
extern UniValue dzlobsstate(const UniValue& params, bool fHelp);
