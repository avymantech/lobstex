...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Lobstex server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Lobstex features */
        {"lobstex", "masternode", &masternode, true, true, false},
        {"lobstex", "listmasternodes", &listmasternodes, true, true, false},
        {"lobstex", "getmasternodecount", &getmasternodecount, true, true, false},
        {"lobstex", "masternodeconnect", &masternodeconnect, true, true, false},
        {"lobstex", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"lobstex", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"lobstex", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"lobstex", "masternodecurrent", &masternodecurrent, true, true, false},
        {"lobstex", "masternodedebug", &masternodedebug, true, true, false},
        {"lobstex", "startmasternode", &startmasternode, true, true, false},
        {"lobstex", "createmasternodekey", &createmasternodekey, true, true, false},
        {"lobstex", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"lobstex", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"lobstex", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"lobstex", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"lobstex", "getmasternodescores", &getmasternodescores, true, true, false},
        {"lobstex", "mnbudget", &mnbudget, true, true, false},
        {"lobstex", "preparebudget", &preparebudget, true, true, false},
        {"lobstex", "submitbudget", &submitbudget, true, true, false},
        {"lobstex", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"lobstex", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"lobstex", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"lobstex", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"lobstex", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"lobstex", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"lobstex", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"lobstex", "checkbudgets", &checkbudgets, true, true, false},
        {"lobstex", "mnsync", &mnsync, true, true, false},
        {"lobstex", "spork", &spork, true, true, false},
        {"lobstex", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzlobsseed", &getzlobsseed, false, false, true},
        {"zerocoin", "setzlobsseed", &setzlobsseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzlobs", &searchdzlobs, false, false, true},
        {"zerocoin", "dzlobsstate", &dzlobsstate, false, false, true},
...
{
    return "> lobstex-cli " + methodname + " " + args + "\n";
}
