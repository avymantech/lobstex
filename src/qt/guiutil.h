...
/** Utility functions used by the Lobstex Qt UI.
 */
namespace GUIUtil
{
...
// Render Lobstex addresses in monospace font
...
// Parse "lobstex:" URI into recipient object, return true on successful parsing
