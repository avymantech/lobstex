 ...
 */
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zLOBS"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zLOBS));
...
void TransactionView::setModel(WalletModel* model)
{
    ...
    if (model) {
        ...
        transactionView->setStyleSheet("border:0px; background-color:rgba(255, 255, 255, 0.8); padding-right:2px;");
